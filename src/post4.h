...
typedef struct {
	...
	P4_Char *	buffer;
	P4_Char *	saved;		/* See SAVE-INPUT and RESTORE-INPUT */
	P4_Int		unget;
...
#define P4_INPUT_PUSH(input)	{ P4_Input input_save; p4SaveInput(input, &input_save);
#define P4_INPUT_POP(input)	p4RestoreInput(input, &input_save); }
