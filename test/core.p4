...
\ Testing nesting.
: tw_read_line REFILL 0= ABORT" REFILL failed" ;
0 tv_si_inc !
2VARIABLE tv_2res -1 S>D tv_2res 2!
: tw_si2
	tw_read_line
	tw_read_line
	SAVE-INPUT
	tw_read_line
	tw_read_line
	tw_str EVALUATE tv_2res 2!
	RESTORE-INPUT
;
\ Do not delete or insert lines of text after tw_si2 is
\ called otherwise the next test will fail.
T{
tw_si2
33333 			\ This line should be ignored
tv_2res 2@ 44444 	\ RESTORE-INPUT should return to this line
