...
.( GH-88 ) test_group
T{ 0 ' FALSE WORDLIST TRAVERSE-WORDLIST -> 0 }T
T{ 0 ' FALSE FORTH-WORDLIST TRAVERSE-WORDLIST ( 0 NT ) 0<> -> 0 TRUE }T
T{ 0 :NONAME DROP 1+ TRUE ; FORTH-WORDLIST TRAVERSE-WORDLIST ( U ) 0 U>  -> TRUE }T
test_group_end
